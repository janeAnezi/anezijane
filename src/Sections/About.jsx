...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('ahnnieanezi@gmail.com');
    setHasCopied(true);
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I’m Anezi Jane</p>
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I specialize in Javascript with a focus on React and Next.js ecosystems building robust and scalable applications.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">I&apos;m based in Abuja, Nigeria and open to remote work worldwide.</p>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">ahnnieanezi@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
